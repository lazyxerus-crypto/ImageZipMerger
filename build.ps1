...
$taskOutput = Join-Path $PSScriptRoot 'build/ImageZipMerger-v1.8'
New-Item -ItemType Directory -Force $taskOutput | Out-Null
& "$env:WINDIR\Microsoft.NET\Framework64\v4.0.30319\csc.exe" /nologo /platform:x64 /target:winexe "/out:$taskOutput\ImageZipMerger.exe" /reference:System.Windows.Forms.dll /reference:System.Drawing.dll /reference:System.IO.Compression.dll /reference:System.IO.Compression.FileSystem.dll ImageZipMerger.cs ModernImage.cs EpisodeListBox.cs
...
Compress-Archive -Path $taskOutput -DestinationPath 'build/ImageZipMerger-v1.8.zip' -Force
