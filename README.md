...
배포 파일 `ImageZipMerger-v1.8.zip`을 모두 압축 해제한 뒤 `ImageZipMerger.exe`를 실행하세요. 같은 폴더의 `libvips-42.dll`이 필요합니다. 저장소의 **Code → Download ZIP**은 소스코드용입니다.
...
결과는 `build/ImageZipMerger-v1.8/`과 `build/ImageZipMerger-v1.8.zip`입니다.
